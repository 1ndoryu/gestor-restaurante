...
#[openapi(
    paths(
        ...
        ventas::pago_parcial_local,
        ventas::factura_local,
    ...
    components(schemas(
        ...
        ventas::PagoLocalRequest,
        ventas::PagoLocalResponse,
        ventas::FacturaLocalRequest,
        ventas::FacturaLocalResponse,
