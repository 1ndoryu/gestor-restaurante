...
export interface ActualizarConfiguracionRequest {
  ...
  /** @nullable */
  bdp_backup_retention_days?: number | null;
  /** @nullable */
  bdp_base_url?: string | null;
  /** @nullable */
  bdp_catalog_price_type?: number | null;
  /** @nullable */
  ...
  /** @nullable */
  bdp_sync_mode?: string | null;
  bdp_tender_map?: unknown | null;
  /** @nullable */
  ff_bdp_auto_arm?: boolean | null;
  /** @nullable */
  ff_bdp_cancel_order?: boolean | null;
  /** @nullable */
  ff_bdp_partial_payments?: boolean | null;
  /** @nullable */
  ff_bdp_purchase_notes_draft?: boolean | null;
  /** @nullable */
  ff_bdp_purchase_notes_read?: boolean | null;
  /** @nullable */
  ff_bdp_purchase_notes_receive?: boolean | null;
  /** @nullable */
...
export interface BdpAuditEntry {
  ...
  created_at: string;
  datos_enviados?: unknown | null;
  datos_respuesta?: unknown | null;
  direccion: string;
  /** @nullable */
 ...
 */
export interface ExploracionCategoria {
  /**
 ...
 */
export interface BdpExploracionResultado {
  articulos: ExploracionCategoria;
  clientes: ExploracionCategoria;
  departamentos: ExploracionCategoria;
  empleados: ExploracionCategoria;
  /** Timestamp de la exploración */
  explorado_at: string;
  /** Resumen general */
  resumen: string;
  salones: ExploracionCategoria;
}
...
export interface BdpInvoiceRequest {
  ...
  confirmacion: string;
  /** @nullable */
  confirmation_destino?: string | null;
  /** @nullable */
 ...
 */
export type BdpPurchaseNoteEstado = typeof BdpPurchaseNoteEstado[keyof typeof BdpPurchaseNoteEstado];


export const BdpPurchaseNoteEstado = {
  pendiente: 'pendiente',
  borrador: 'borrador',
 ...
 */
export interface BdpPurchaseNoteDraftRequest { [key: string]: unknown }

/**
 * Parámetros de consulta para listar albaranes.
 */
export interface BdpPurchaseNoteListParams {
  /** @nullable */
...
export interface BdpPurchaseNoteReconcileRequest {
  ...
  /**
     ...
     * @nullable
     */
  gasto_existente_id?: string | null;
}
...
export interface BdpPurchaseNoteSyncRequest {
  /** @nullable */
  export_profile_code?: number | null;
  /** @nullable */
  fecha_desde?: string | null;
  /** @nullable */
  fecha_hasta?: string | null;
  /** @nullable */
  proveedor_desde?: number | null;
  /** @nullable */
  proveedor_hasta?: number | null;
}
...
export interface CambiarModoOperacionRequest {
  /** 'auto' | 'standalone' | 'bdp' */
  modo: string;
}
...
export interface ConfiguracionRestaurante {
  ...
  /** @nullable */
  bdp_env_bootstrap_applied_at?: string | null;
...
export interface ModoOperacionResponse {
  modo_efectivo: string;
  modo_operacion: string;
}
...
export interface ReintentarBdpSyncRequest {
  auto_arm?: boolean;
  /** @nullable */
...
export interface RestoreGloryRequest {
...
export interface SnapshotGloryRequest {
  /** @nullable */
  notas?: string | null;
  tipos: string[];
}

export interface SnapshotParcialRequest {
  /** @nullable */
  notas?: string | null;
  tipos: string[];
}
...
export type ListarAuditParams = {
/**
 * Máximo de entradas a devolver (default 100)
 * @nullable
 */
limit?: number | null;
};

export type ListarSnapshotsParams = {
/**
 * Máximo de snapshots a devolver (default 50)
 * @nullable
 */
limit?: number | null;
};

export type ListarPurchaseNotesParams = {
/**
 * Filtro por código o nombre de proveedor
 * @nullable
 */
proveedor?: string | null;
/**
...
export type BuscarReservasChatbotParams = {
/**
