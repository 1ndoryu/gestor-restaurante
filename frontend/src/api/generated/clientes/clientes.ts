...
export const crearCliente = async (crearClienteRequest: CrearClienteRequest, options?: RequestInit): Promise<crearClienteResponse> => {
  ...
  return customInstance<crearClienteResponse>(getCrearClienteUrl(),
  {
    ...
    body: JSON.stringify(crearClienteRequest)
  }
);}
...
export const mergeClientes = async (mergeClientesRequest: MergeClientesRequest, options?: RequestInit): Promise<mergeClientesResponse> => {
  ...
  return customInstance<mergeClientesResponse>(getMergeClientesUrl(),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(mergeClientesRequest)
  }
);}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getObtenerClienteQueryKey(id);
   ...
   return  { queryKey, queryFn, enabled: id !== null && id !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof obtenerCliente>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export const actualizarCliente = async (id: string,
  ...
  return customInstance<actualizarClienteResponse>(getActualizarClienteUrl(id),
  {
    ...
    method: 'PUT',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(actualizarClienteRequest)
  }
);}
