...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getObtenerEtiquetasClienteQueryKey(id);
   ...
   return  { queryKey, queryFn, enabled: id !== null && id !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof obtenerEtiquetasCliente>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export const asignarEtiquetaCliente = async (id: string,
  ...
  return customInstance<asignarEtiquetaClienteResponse>(getAsignarEtiquetaClienteUrl(id),
  {
    ...
    body: JSON.stringify(tagAssignBody)
  }
);}
...
export const crearEtiqueta = async (crearEtiquetaRequest: CrearEtiquetaRequest, options?: RequestInit): Promise<crearEtiquetaResponse> => {
  ...
  return customInstance<crearEtiquetaResponse>(getCrearEtiquetaUrl(),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(crearEtiquetaRequest)
  }
);}
...
export type listarCategoriasResponse401 = {
  data: ErrorResponse
  status: 401
}
...
export type listarCategoriasResponseError = (listarCategoriasResponse401) & {
  headers: Headers;
};

export type listarCategoriasResponse = (listarCategoriasResponseSuccess | listarCategoriasResponseError)
...
/**
 * @summary Listar categorías de etiquetas
 */
...
export const getListarCategoriasQueryKey = () => {
    return [
    `/api/etiquetas/categorias`
    ] as const;
    }


export const getListarCategoriasQueryOptions = <TData = Awaited<ReturnType<typeof listarCategorias>>, TError = ErrorResponse>( options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof listarCategorias>>, TError, TData>>, request?: SecondParameter<typeof customInstance>}
) => {
...
export type ListarCategoriasQueryError = ErrorResponse


export function useListarCategorias<TData = Awaited<ReturnType<typeof listarCategorias>>, TError = ErrorResponse>(
...
export const crearCategoria = async (crearCategoriaEtiquetaRequest: CrearCategoriaEtiquetaRequest, options?: RequestInit): Promise<crearCategoriaResponse> => {
  ...
  return customInstance<crearCategoriaResponse>(getCrearCategoriaUrl(),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(crearCategoriaEtiquetaRequest)
  }
);}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getObtenerEtiquetasReservaQueryKey(id);
   ...
   return  { queryKey, queryFn, enabled: id !== null && id !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof obtenerEtiquetasReserva>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
