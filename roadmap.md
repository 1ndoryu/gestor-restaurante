...
| 1b  | **Lecturas reales BDP, sin escrituras** — conexión, acceso y formas de pago verificados. El catálogo respondió correctamente pero sin artículos; Compras quedó bloqueado porque BDP exige una plantilla de exportación válida; el Explorador necesita códigos reales de menú/pack para completar su comprobación. No se efectuó ningún cambio en BDP. | Cliente: confirmar perfil de artículos, código de plantilla de compras y códigos reales de menú/pack | ~1h sesión |
