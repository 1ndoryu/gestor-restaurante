...
- 065A-4 — Validar BDP/WebLink contra PC real del restaurante: conectividad Tailscale y diagnostico Health/Login/GetVersion ya probados. Pendiente operativo: ejecutar en producción el botón `Probar sincronización segura`, confirmar `listo_para_sincronizar = true`, documentar captura/resultado para el cliente y, solo después, activar el modo de escritura real de comandas/pagos.
